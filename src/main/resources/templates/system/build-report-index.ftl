...
<div class="container-fluid">
    ...
    <#include "../public/common.ftl" />
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            action="${basePath}/SystemController/buildReportIndex">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="menuName" class="form-control"
                           id="menuName" placeholder="名称" value="${from.menuName!}">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td>${p.id!}</td>
                        <td>${p.menuName!}</td>
                        <td>/baseController/${p.id}/index</td>
                        <td>${p.remark!}</td>
                        <td>
...
<script type="text/javascript" >
    ...
    function confrimDelete(id){
        $.confirm({
            title: '删除',
            content: '确定要删除这个报表吗，删除后无法还原！确定吗？',
            buttons:{
                confirm: {
                    text:'确定',
                    ...
                    action:function(){
                        $.ajax({
                            url:basePath + '/SystemController/deleteBuildReport',
                            type:"post",
                            dataType:'json',
                            data:{
                                'id':id
    ...
    function edit(id){
        if(id == null || typeof(id)=='undefined')
            window.location.href = basePath + "/SystemController/editBuildReport";
        else
            window.location.href = basePath + "/SystemController/editBuildReport?id="+id;
    }
</script>
</body>
</html>
