...
<script type="text/javascript" >
    ...
    function dataAjax(){
        ...
        $.ajax({
            url:basePath + '/BusinessController/takeBtcDataTotal',
            type:"post",
            dataType:'json',
            ...
            success:function(data){
                ...
                $.each(data.success.list,function(i,u){
                    ...
                    var line = '<tr>';
                    line += '<td>'+u.date+'</td>';
                    line += '<td>'+u.withdrawbtcCount+'</td>';
                    line += '<td>'+u.withdrawbtcAmount+'</td>';
                    line += '<td>'+u.withdrawbtcFee+'</td>';
                    line += '<td>'+u.withdrawbtcUsers+'</td>';
                    line += '</tr>';
                    html += line;
