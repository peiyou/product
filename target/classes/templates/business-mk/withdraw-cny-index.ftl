...
<script type="text/javascript" >
    ...
    function dataAjax(){
        ...
        $.ajax({
            url:basePath + '/BusinessController/takeCnyDataTotal',
            type:"post",
            dataType:'json',
            ...
            success:function(data){
                ...
                $.each(data.success.list,function(i,u){
                    ...
                    var line = '<tr>';
                    line += '<td>'+u.date+'</td>';
                    line += '<td>'+u.withdrawcnyCount+'</td>';
                    line += '<td>'+u.withdrawcnyAmount+'</td>';
                    line += '<td>'+u.withdrawcnyFee+'</td>';
                    line += '<td>'+u.withdrawcnyUsers+'</td>';
                    line += '</tr>';
                    html += line;
